...
import 'package:pashboi/features/authenticated_pages/my_accounts/presentation/pages/account_openning_page/parts/account_operator_section.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SingleChildScrollView(child: stepWidgets[currentStep - 1]),
              const SizedBox(height: 24),
              Row(
