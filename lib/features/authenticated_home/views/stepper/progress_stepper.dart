...
import 'package:pashboi/features/authenticated_home/views/stepper/utility/step_factory.dart';

typedef ProgressStepperBuilder =
...
class ProgressStepper extends StatelessWidget with StepFactory {
  ...
  Widget build(BuildContext context) => SizedBox(
    width: width,
    height: height,
    child: Stack(children: _getProgressSteps(context)),
  );
